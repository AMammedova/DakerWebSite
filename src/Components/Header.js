...
function Header({setChildWrapperClass,childWrapperClass,updateHome,updatePage}){
      ...
      const updateHam=()=>{
        ...
        return(
          ...
          <div className="content_menu_wrapper">
           ...
           <div  className="header_menu_block">menu
            
            <svg   onClick={() => { updateHam();updateMenu();}} className={ham} viewBox="0 0 100 100" width="80">
      <path
